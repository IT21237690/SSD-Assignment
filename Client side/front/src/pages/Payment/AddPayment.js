...
const AddPayment = () => {
  ...
  function sendData(event) {
    ...
    if (
      ...
      axios
        .post("/payment/add", newPayment)
        .then(() => {
          Swal.fire("Successful !", "Payment Added!", "success");
        })
        .catch((err) => {
          Swal.fire({
            icon: "error",
        ...
        <form className="row g-3" style={{ marginTop: "50px" }}>
          <div className="col-md-6">
            ...
            <input
              ...
              placeholder="Muditha Pradeeptha Jayawickrama"
              required
              pattern="/^[a-zA-Z ]*$/"
              onChange={(event) => {
            ...
            />
            {error && name.length <= 0 ? (
              <label className={style.DangerLabel}>
