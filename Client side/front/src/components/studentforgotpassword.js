...
function SutdentForgotPassword() {
  ...
  const handleEmailSubmit = (e) => {
    ...
    axios.post("/student/forgot-password", { email }).then((res) => {
  ...
  const handleAnswerSubmit = (e) => {
    ...
    axios.post("/student/forgot-password", { email, answer, password }).then((res) => {
...
export default SutdentForgotPassword;
