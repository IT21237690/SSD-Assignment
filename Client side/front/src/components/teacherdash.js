                    ...
                    <div class="row m-l-0 m-r-0">
                      <div class="col-sm-4 bg-c-lite-green user-profile">
                        <div class="card-block text-center text-white">
                          ...
                          >
                            {logindata
                              ? logindata.Validteacher.name.toUpperCase()
                              : ""}{" "}
                          </h6>
                          ...
                          <div class="card-block">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <h6 class="text-muted f-w-400">
                                  {logindata ? logindata.Validteacher.nic : ""}
                                  <br />
                                  <br />
                                </h6>
                              </div>
                              <div class="col-sm-6">
                                ...
                                <h6 class="text-muted f-w-400">
                                  {logindata
                                    ? logindata.Validteacher.address
                                    : ""}
                                  <br />
                                  <br />
                                </h6>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <h6 class="text-muted f-w-400">
                                  {logindata
                                    ? logindata.Validteacher.subject.toUpperCase()
                                    : ""}
                                  <br />
                                  <br />
                                </h6>
