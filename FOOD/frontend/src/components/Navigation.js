...
function Navigation() {
    ...
    return (
                ...
                <Navbar style={{ backgroundColor: '#FFFFFF', paddingTop: '20px', paddingBottom: '20px' }} expand="lg">
  {/* Navbar content */}
            <Container>
                <LinkContainer to="/">

                <Navbar.Brand className="custom-brand" >W I S H W A - F O O D S</Navbar.Brand>
                 {/*   <Navbar.Brand>WISHWA FOODS</Navbar.Brand>*/}
                </LinkContainer>
